...
public partial class MsgBox : Form
{
    ...
    {
        new() { Name = "okBtn", Text = Resources.okBtn_Text, DialogResult = DialogResult.OK },
        new() { Name = "cancelBtn", Text = Resources.cancelBtn_Text, DialogResult = DialogResult.Cancel },
        new() { Name = "yesBtn", Text = Resources.yesBtn_Text, DialogResult = DialogResult.Yes },
        new() { Name = "noBtn", Text = Resources.noBtn_Text, DialogResult = DialogResult.No },
        new() { Name = "abortBtn", Text = Resources.abortBtn_Text, DialogResult = DialogResult.Abort },
        new() { Name = "retryBtn", Text = Resources.retryBtn_Text, DialogResult = DialogResult.Retry },
        new() { Name = "ignoreBtn", Text = Resources.ignoreBtn_Text, DialogResult = DialogResult.Ignore }
    };
